...
public class HotelBooking 
{
	public static void main(String[] args) 
	{
		...
		Boolean roomFound = false, start = true;
	    ...
	    Booking Request = new Booking(occupancy,ac,floor);  
	    
	    for(Room room: Rooms) 
	    {
	    	if(room.getVacancy()==true) 
	    	{
	    		if(Request.getOccupancy()==(room.getOccupancy()))
	    			{
	    				if(Request.getAc()!=null && Request.getAc()==(room.getAc()))
	    				{
	    					if(Request.getFloor()!=null && Request.getAc()==(room.getAc())) 
	    					{
	    						roomFound = true;
	    						room.setVacancy();
	    						System.out.println("Room Number: "+room.getRoomNo()+", "+room.getFloor()+", "+room.getAc()+", "
